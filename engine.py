...
def main():
    ...
    colors = {
        'dark_wall': libtcod.Color(255,0,0),
        'dark_ground': libtcod.Color(255,153,0),
        'light_wall': libtcod.Color(255,204,0),
        'light_ground': libtcod.Color(255,255,102)
    }
        ...
        for player_turn_result in player_turn_results:
            ...
            if dead_entity:
                if dead_entity == player:
                    ...
                    message = death_functions.kill_monster(dead_entity)
